# 302 — Pierwszy DOM i formularz

Etap 2/12. HTML tworzy pola, JavaScript odczytuje wpis i aktualizuje tekst na stronie.

## Wymagania wstępne

Ukończ [Podstawy JavaScript](../301-javascript-podstawy/README.md). Otwórz index.html; nie potrzebujesz XAMPP. Kod zmieniaj w app.js, zapisuj i odświeżaj stronę.
...
Brak # w selektorze lub inny id zwraca null. Walidację samych spacji dodamy w lekcji 305.
