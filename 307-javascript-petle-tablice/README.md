...
1. Oblicz minimum, maksimum i średnią ocen.
2. Policz oceny powyżej średniej.
3. Dodaj komunikat dla pustej tablicy.
4. Wypisz wynik przez DOM, a nie przez `innerHTML` z danymi użytkownika.
