# 311 — Projekt pod INF.03: Studio Foto
...
Odtwórz całość w folderze `start` bez oglądania rozwiązania, potem zaznacz
kryteria i zapisz znalezione różnice. Dodaj własną regułę walidacji, własną
pozycję tabeli i dodatkowy stan pustej galerii.
