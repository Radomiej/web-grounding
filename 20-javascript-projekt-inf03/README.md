# 20 — Projekt pod INF.03: Studio Foto
...
Lekcje 10, 11 i 13–19. Zacznij w [start/index.html](start/index.html), rozwiązanie znajduje się w [index.html](index.html). Wariant startowy celowo zawiera tylko szkielet; nie jest niedokończonym rozwiązaniem.
...
Powtórzenie funkcji/konwersji (13), if i checked (14), walidacji (15), pętli i tablic (16), src/alt (17), obiektów i createElement (18). `amount *= 0.9` mnoży kwotę przez 90%; `total += amount` sumuje wyceny. `replaceChildren()` usuwa wszystkie wiersze. Indeks galerii używa modulo %, aby wrócić do początku.
