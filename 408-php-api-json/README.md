# Ćwiczenie 408 — PHP API: JSON i `fetch()`

To pierwsza lekcja API i dopiero teraz przechodzimy z PHP osadzanego w HTML do
oddzielnego endpointu. Wcześniejsze `401–407` renderują stronę po stronie PHP;
tutaj `api.php` zwraca dane, a JavaScript buduje widok.
