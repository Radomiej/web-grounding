# 312 — Animacja Canvas i HUD HTML
...
Canvas z lekcji 311, obiekty i zdarzenia z wcześniejszych lekcji.
...
Rysowanie, DPR i setTransform: [lekcja 311](../311-canvas-podstawy/README.md#javascript). Warunki oraz operator ?: (wybierz jedną z dwóch wartości) sterują komunikatami i etykietą pauzy.
