...
1. Dodaj trójkąt przez `beginPath`, `moveTo`, `lineTo`, `closePath` i `fill`.
2. Dodaj podpis pod prostokątem przez `fillText`.
3. Dodaj drugi lokalny obraz i stan błędu dla brakującego pliku.
4. Sprawdź skalowanie DPR oraz reset po zmianie rozmiaru okna.
