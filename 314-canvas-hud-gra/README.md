...
Canvas z lekcji 313, timer z 312, obiekty i zdarzenia z wcześniejszych lekcji.
...
Rysowanie, DPR i setTransform: [lekcja 313](../313-canvas-podstawy/README.md#javascript). Warunki oraz operator ?: (wybierz jedną z dwóch wartości) sterują komunikatami i etykietą pauzy.
...
1. Dodaj licznik zebranych celów do HTML HUD.
2. Ustaw go w lewym dolnym rogu przez `position: absolute`.
3. Wyzeruj licznik po restarcie i nie twórz drugiej pętli animacji.
4. Dodaj stan game over oraz zablokuj pauzę po utracie wszystkich żyć.
