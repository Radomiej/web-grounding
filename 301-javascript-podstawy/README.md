# 301 — Podstawy JavaScript

Etap 1/12. Pierwszy skrypt: uruchom F12 → Console. Zmień jedną wartość, zapisz i odśwież stronę.

## Wymagania wstępne

Ukończ HTML 101–102 oraz CSS/Flexbox 201–204. Otwórz index.html; nie potrzebujesz XAMPP. Kod zmieniaj w app.js, zapisuj i odświeżaj stronę.

## Czego się nauczysz

- const / let: Stałe przypisanie / zmienna z możliwością ponownego przypisania.
- string, number, boolean: Tekst 'Bilet', liczba 18 i wartość logiczna true.
- = oraz + - * / %: Przypisanie oraz dodawanie, odejmowanie, mnożenie, dzielenie i reszta z dzielenia.
- console.log(...): Wypisuje argumenty w konsoli; przecinki rozdzielają argumenty.
- 'use strict': Włącza rygorystyczny tryb wykrywający część błędów.
- //: Komentarz do końca wiersza. Nie jest wykonywany.

## Krok po kroku

1. Odczytaj typ każdej wartości.
2. Policz 18 × 3 na papierze i porównaj z konsolą.
3. Zwiększ quantity. Sprawdź, że wcześniej obliczone total nie aktualizuje się samo.

## Przepływ danych

Literały → zmienne → obliczenia → console.log. Zmiana quantity nie przelicza automatycznie total.
...
Tekst '18' nie jest tym samym typem co liczba 18. Operator + może sklejać teksty.

## Zadanie

Dodaj cenę drugiego produktu i oblicz łączną kwotę.
