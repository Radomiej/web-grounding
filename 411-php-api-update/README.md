# Ćwiczenie 411 — PHP API: edycja rekordu

Po dodawaniu (`409`) i filtrowaniu (`410`) przyszedł czas na aktualizację.
...
- Żądanie `PUT` jest walidowane, a `UPDATE` ma warunek `WHERE id = ?`.
- Nieistniejące ID zwraca `404`, a dane odpowiedzi nie ujawniają SQL.
- Uczeń umie porównać aktualizację osadzaną z 406 i API z 411.
