# 19 — Tekst, czas i zapis

Etap 9/12. JSON zapisuje obiekt jako tekst. Odczyt może się nie udać, więc strona ma działać także bez zapisu.

## Wymagania wstępne

Ukończ [Obiekty i dynamiczna lista](../18-javascript-lista/README.md). Otwórz index.html; nie potrzebujesz XAMPP. Kod zmieniaj w app.js, zapisuj i odświeżaj stronę.
...
Dodaj ustawienie rozmiaru tekstu z dozwolonymi wartościami mały/duży.
