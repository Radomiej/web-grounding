...
Najpierw [07 — sandbox](../07-flexbox-sandbox/README.md), potem [09 — rozwinięcie](../09-flexbox-wiecej-mozliwosci/README.md).

## Krok po kroku — zagnieżdżanie

1. W generatorze 07 ustaw dwie kolumny i pobierz layout.html.
