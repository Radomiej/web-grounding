# 18 — Obiekty i dynamiczna lista

Etap 8/12. Obiekt opisuje jedno zadanie. Tablica jest źródłem danych, a renderowanie odtwarza listę.

## Wymagania wstępne

Ukończ [Wygląd i galeria](../17-javascript-galeria/README.md). Otwórz index.html; nie potrzebujesz XAMPP. Kod zmieniaj w app.js, zapisuj i odświeżaj stronę.
...
Dodaj pole ukończone i filtr tylko nieukończonych.
