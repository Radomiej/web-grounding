# 07 — Flexbox: laboratorium i generator
...
HTML i formularze (01–02). Otwórz index.html. Sandbox jest narzędziem do nauki CSS; znajomość jego JS nie jest wymagana. Po lekcji 18 możesz wrócić i przeanalizować implementację.
...
Przepływ: kontrolka → sprawdzone ustawienie → render podglądu + objaśnienia + eksport. Wszystkie trzy wyniki czytają ten sam stan. Generator obsługuje jeden kontener, 0–20 dzieci; zagnieżdżenia zbudujesz ręcznie w lekcji 08.
...
Odtwórz nawigację, karty i dwie kolumny bez presetu. Po eksporcie dodaj własną treść i zagnieżdżony kontener.
