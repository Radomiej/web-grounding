# 15 — Walidacja formularza

Etap 5/12. Przeglądarka sprawdza format, a skrypt dodatkowe zasady. Błąd musi mówić, co poprawić.

## Wymagania wstępne

Ukończ [Warunki i kontrolki](../14-javascript-warunki/README.md). Otwórz index.html; nie potrzebujesz XAMPP. Kod zmieniaj w app.js, zapisuj i odświeżaj stronę.
...
Dodaj obowiązkowe pole telefonu z opisem oczekiwanego formatu.
