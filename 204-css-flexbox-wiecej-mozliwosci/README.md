# Ćwiczenie 204 — więcej możliwości Flexbox
...
1. Ustaw wszystkim kartom `flex-grow: 0` i zapisz, co stało się z wolnym miejscem.
2. Zmień `flex-basis` na `20rem` oraz `10rem` i sprawdź zawijanie.
3. Usuń `margin-top: auto` z przycisku i wyjaśnij zmianę wysokości kart.
4. Przywróć poprawną kolejność wizualną, usuwając `order`.
5. Dodaj wariant z `align-self: flex-end` i sprawdź fokus klawiatury.

## Wymagania wstępne i progresja

Wykonaj [203](../203-css-flexbox-wlasny-layout/README.md). Dalej: [301 — JavaScript](../301-javascript-podstawy/README.md).
