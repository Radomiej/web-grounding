# Ćwiczenie 412 — PHP API: usuwanie rekordu
...
- Żądanie `DELETE` wymaga dodatniego ID i używa prepared statement.
- Pierwsze usunięcie oraz ponowienie dla tego samego ID mają różne, opisane statusy.
- Potwierdzenie chroni przed przypadkową operacją destrukcyjną.
